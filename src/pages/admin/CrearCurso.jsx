  ...
  return (
    <main className="admin-page">
      <section className="admin-header">
        <h1>Crear Curso</h1>
        <p>Agrega un nuevo curso al catálogo de Green World.</p>
      </section>
      ...
      <form className="admin-form" onSubmit={handleSubmit}>
        ...
        <label>Duración estimada<input name="duracion_estimada" value={form.duracion_estimada} onChange={handleChange} placeholder="2 horas" /></label>
        <label>Nivel
